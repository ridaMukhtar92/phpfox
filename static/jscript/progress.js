        ...
        if (bIsHTML5ProgressUpload){
            $('.js_uploader_files_input')[0].addEventListener("change", function(e) {
              ...
              if (iTotalUploadedFiles > oProgressBar.max_upload){
                $('#js_upload_error_message').html('<div class="error_message">' + oTranslations['photo.maximum_number_of_images_you_can_upload_each_time_is'] + ' ' + oProgressBar.max_upload + '</div>').show();
                setTimeout(function(){
