...
<a href="{link}">{link}</a>]]></phrase>
		...
		<phrase module_id="mail" version_id="4.1.1" var_name="can_not_send_empty_message" added="1449142235">Cannot send empty message!</phrase>
		<phrase module_id="mail" version_id="4.1.1" var_name="can_not_reply_due_to_privacy_settings" added="1449142235">You cannot reply this conversation at this time due to privacy settings.</phrase>
		<phrase module_id="mail" version_id="4.1.2" var_name="archive_message_s" added="1449635185">Archive Message(s)</phrase>
        <phrase module_id="mail" version_id="4.1.2" var_name="viewing_message" added="1450153372"><![CDATA[Viewing Message]]></phrase>
		<phrase module_id="mail" version_id="4.1.2" var_name="please_select_at_least_one_user_to_send_message" added="1450251170">Please select at least one user to send message.</phrase>
	</phrases>
	<user_group_settings>
