...
<div id="js_main_mail_thread_holder">
	<div class="mail_messages">
		...
		<a href="javascript:void(0)" id="js_mail_thread_view_more" class="mail_view_more" rel="{$aThread.thread_id}">{phrase var='mail.view_more'}</a>
		{/if}
	...
	<div class="mail_thread_form_holder">
		<div class="mail_thread_form_holder_inner">
			...
			{else}
			<div class="message">{phrase var='mail.can_not_reply_due_to_privacy_settings'}</div>
			{/if}
		</div>
	</div>
</div>