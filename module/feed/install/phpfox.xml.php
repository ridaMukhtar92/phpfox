...
For this to work you need to have entered the Google API Key (<setting>google_api_key</setting></info>) or the IP Info DB Key (<setting>ip_infodb_api_key</setting>)]]></phrase>
		...
		<phrase module_id="feed" version_id="4.0.10" var_name="what_s_up" added="1446431801"><![CDATA[What's up?]]></phrase>
		...
		<phrase module_id="feed" version_id="4.1.2" var_name="check_in" added="1449833947">Check-in</phrase>
		<phrase module_id="feed" version_id="4.1.2" var_name="you_have_number_updates" added="1449834126">You have {number} updates</phrase>
		<phrase module_id="feed" version_id="4.1.2" var_name="select_a_friend_to_share_this_with_dot" added="1450090931">Select a friend to share this with.</phrase>
		<phrase module_id="feed" version_id="4.1.2" var_name="egift_card_with_message" added="1450091017">egift card with message</phrase>
		<phrase module_id="feed" version_id="4.1.2" var_name="method_deprecated_since_2_dot1_dot0beta1" added="1450147327">Method deprecated since 2.1.0beta1</phrase>
		<phrase module_id="feed" version_id="4.2.0" var_name="posting_as" added="1451978663">Posting as</phrase>
		<phrase module_id="feed" version_id="4.2.1" var_name="show_more" added="1454388676">Show More</phrase>
		<phrase module_id="feed" version_id="4.3.0" var_name="view_more_plus" added="1456299989">More +</phrase>
		<phrase module_id="feed" version_id="4.4.0" var_name="setting_allow_choose_sort_on_feeds" added="1460363518"><![CDATA[<title>Allow choose sort type on Main feeds</title><info>Set <b>true</b> to allow users can choose sort type of main feeds in home page.</info>]]></phrase>
	</phrases>
	<user_group_settings>
