	...
	<form method="post" action="{url link='pages.add'}" enctype="multipart/form-data">
		...
		<div id="js_pages_block_detail" class="js_pages_block page_section_menu_holder">
			...
			<div class="table_clear">
				<input type="submit" value="{phrase var='pages.update'}" class="button btn-primary" />
			</div>
		</div>
			...
			<div class="table_clear" id="js_pages_vanity_url_button">
				<ul class="table_clear_button">
					<li>
						...
						<input type="button" value="{phrase var='pages.check_url'}" class="button btn-primary" onclick="if ($('#js_vanity_url_new').val() != $('#js_vanity_url_old').val()) {l} $Core.processForm('#js_pages_vanity_url_button'); $($(this).parents('form:first')).ajaxCall('pages.changeUrl'); {r} return false;" />
					</li>
		...
		<div id="js_pages_block_photo" class="js_pages_block page_section_menu_holder" style="display:none;">
			<div id="js_pages_block_customize_holder">
				...
				<div id="js_submit_upload_image" class="table_clear"{if $bIsEdit && !empty($aForms.image_path)} style="display:none;"{/if}>
					<input type="submit" value="{phrase var='pages.upload_photo'}" class="button btn-primary" />
				</div>
			</div>	
		</div>		
		...
		<div id="js_pages_block_invite" class="js_pages_block page_section_menu_holder" style="display:none;">
			<div class="block">
				<div class="content">
					...
					{/if}
					<div class="p_top_8">
						<input type="submit" value="{phrase var='pages.send_invitations'}" class="button btn-primary" />
					</div>
				</div>
			</div>
		</div>		
							...
							<div class="row_edit_bar_parent" style="display:block;">
								<div class="row_edit_bar">
									...
									<ul class="dropdown-menu">
										<li>
											<a href="#" onclick="$Core.box('pages.widget', 700, 'widget_id={$aWidgetEdit.widget_id}'); return false;">{phrase var='pages.edit'}</a>
										</li>
										<li class="item_delete">
											<a href="#" onclick="if (confirm('Are you sure?')) {l} $.ajaxCall('pages.deleteWidget', 'widget_id={$aWidgetEdit.widget_id}'); {r} return false;">{phrase var='pages.delete'}</a>
										</li>
									</ul>
								</div>
							</div>
			...
			<div class="pages_type_add_form_holder">
				<form method="post" action="#">
					...
					<div class="table_clear" id="js_pages_add_submit_button">
						<input type="submit" value="{phrase var='pages.get_started'}" class="button btn-primary" />
					</div>
