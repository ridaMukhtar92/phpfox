<module>
	...
	<menus>
        <menu module_id="pages" parent_var_name="" m_connection="main" var_name="module_pages" ordering="103" url_value="pages" version_id="4.1.0" disallow_access="" module="pages" />
	...
	<blocks>
		...
		<block type_id="0" m_connection="pages.index" module_id="pages" component="category" location="1" is_active="1" ordering="10" disallow_access="" can_move="1">
...
Claiming a page is a user group setting, not every member is allowed to claim a page. To enable a user group to claim pages please go to Users -> Manage User Groups.</info>]]></phrase>
		...
		<phrase module_id="pages" version_id="4.1.2" var_name="home" added="1449742435">Home</phrase>
		<phrase module_id="pages" version_id="4.1.2" var_name="unjoin" added="1449805406">Unjoin</phrase>
		<phrase module_id="pages" version_id="4.1.2" var_name="unlike" added="1449805458">Unlike</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="password" added="1449830664">Password</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="enter_the_password_used_to_log_into_the_account" added="1449830735">Enter the password used to log into the account</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="login" added="1449830886">Login</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="claims" added="1449830985">Claims</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="claimed_by" added="1449831028">Claimed By</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="page_owner" added="1449831064">Page Owner</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="grant" added="1449831151">Grant</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="deny" added="1449831188">Deny</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="there_are_no_claims_at_the_moment_dot" added="1449831242">There are no claims at the moment.</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="no_pages" added="1449831328">No pages</phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="that_title_is_not_allowed" added="1450149227"><![CDATA[That title is not allowed]]></phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="not_a_valid_claim" added="1450149291"><![CDATA[Not a valid claim]]></phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="user_is_not_an_admin" added="1450149364"><![CDATA[User is not an admin]]></phrase>
        <phrase module_id="pages" version_id="4.1.2" var_name="the_photo_does_not_belong_to_this_page" added="1450149423"><![CDATA[The photo does not belong to this page]]></phrase>
        <phrase module_id="pages" version_id="4.2.0" var_name="successfully_deleted_user_s_dot" added="1451277618"><![CDATA[Successfully deleted user(s).]]></phrase>
        <phrase module_id="pages" version_id="4.2.0" var_name="successfully_approved_user_s_dot" added="1451277868"><![CDATA[Successfully approved user(s).]]></phrase>
        <phrase module_id="pages" version_id="4.2.1" var_name="followers" added="1454380328"><![CDATA[Followers]]></phrase>
        <phrase module_id="pages" version_id="4.2.1" var_name="follower" added="1454380457"><![CDATA[Follower]]></phrase>phrases
        <phrase module_id="pages" version_id="4.3.0" var_name="liked_pages" added="1455511478"><![CDATA[Liked pages]]></phrase>
        <phrase module_id="pages" version_id="4.3.0" var_name="pages_you_created_and_joined" added="1455512419"><![CDATA[Pages you created and joined]]></phrase>
		<phrase module_id="pages" version_id="4.3.0" var_name="members" added="1455512419"><![CDATA[Members]]></phrase>
		<phrase module_id="pages" version_id="4.3.1" var_name="posting_as" added="1459738364">Posting as</phrase>
		<phrase module_id="pages" version_id="4.4.0" var_name="are_you_sure_you_want_to_transfer_ownership" added="1460340562"><![CDATA[Are you sure you want to transfer ownership?]]></phrase>
		<phrase module_id="pages" version_id="4.4.0" var_name="are_you_sure_you_want_to_deny_this_claim_request" added="1460340562"><![CDATA[Are you sure you want to deny this claim request?]]></phrase>
	</phrases>
	<user_group_settings>
