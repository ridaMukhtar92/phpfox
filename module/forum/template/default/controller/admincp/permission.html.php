...
<form method="post" action="#" onsubmit="$(this).ajaxCall('forum.savePerms'); return false;">	
	...
	<div class="table_clear">
		<div id="js_save_perms" style="display:none;">
			<input name="save" type="submit" value="{phrase var='forum.save'}" class="button btn-primary" />
			<input name="button "type="submit" value="{phrase var='forum.reset'}" class="button btn-danger" onclick="$.ajaxCall('forum.permReset', 'forum_id={$iForumId}&amp;user_group_id=' + $('#js_form_user_group_id').val()); return false;" />
		</div>
	</div>
</form>