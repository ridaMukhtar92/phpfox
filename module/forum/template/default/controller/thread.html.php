		...
		<div class="forum_header_menu">
			<ul class="sub_menu_bar">
				...
				<li class="sub_menu_bar_li dropdown">
					<a role="button" data-toggle="dropdown" class="sJsDropMenu drop_down_link">{phrase var='forum.thread_tools'}</a>
...
<!--                        {* 2 = sponsored *}-->
						...
						{elseif Phpfox::getUserParam('forum.can_purchase_sponsor') && Phpfox::getService('forum')->getSponsorPrice()}
						<li>
				...
				<li class="sub_menu_bar_li">
					<a href="{url link='forum.rss' thread=$aThread.thread_id}" title="{phrase var='forum.subscribe_to_this_thread'}" class="no_ajax_link rss_link">
