...
<a href="{link}">{link}</a>]]></phrase>
		...
		<phrase module_id="music" version_id="4.1.2" var_name="album_songs_count" added="1449822092">{songs_count} songs</phrase>
        <phrase module_id="music" version_id="4.1.2" var_name="unable_to_find_the_song_you_are_looking_for_dot" added="1450149018"><![CDATA[Unable to find the song you are looking for.]]></phrase>
        <phrase module_id="music" version_id="4.1.2" var_name="unable_to_edit_this_song_dot" added="1450149072"><![CDATA[Unable to edit this song.]]></phrase>
		<phrase module_id="music" version_id="4.2.0" var_name="moderation" added="1451533046"><![CDATA[Moderation]]></phrase>
		<phrase module_id="music" version_id="4.2.1" var_name="album_song_count" added="1454057030">{songs_count} song</phrase>
		<phrase module_id="music" version_id="4.3.1" var_name="who_can_share_music" added="1459502242">Who can share music?</phrase>
		<phrase module_id="music" version_id="4.3.1" var_name="who_can_view_music" added="1459502242">Who can view music?</phrase>
		<phrase module_id="music" version_id="4.3.1" var_name="unable_to_view_this_item_due_to_privacy_settings" added="1459502242">Unable to view this item due to privacy settings.</phrase>
	</phrases>
	<user_group_settings>
