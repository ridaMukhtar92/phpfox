...
<input type="hidden" name="action" value="add"/>
	...
	<div class="table_clear">
		<input type="submit" value="{phrase var='contact.add'}" class="button btn-primary" />
	</div>
</form>
...
<form method="post" id="admincp_contact_form_edit" action="{url link='admincp.contact'}">
	...
	<div class="table_bottom">
		...
		<input type="submit" name="update" value="{phrase var='contact.edit'}" class="button btn-primary" />
	</div>
</form>