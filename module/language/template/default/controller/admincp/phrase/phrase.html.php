	...
	<form method="post" action="{url link="admincp.language.phrase"}">
		...
		<div class="table_clear">
			<div class="table_clear_more_options">
				<a href="#" rel="{phrase var='language.view_less_search_options'}" onclick="$('#js_admincp_search_options').toggle(); var text = $(this).text(); $(this).text($(this).attr('rel')); $(this).attr('rel', text); return false;">{phrase var='language.view_more_search_options'}</a>
			</div>
