	...
	<form method="post" action="{url link='blog.add'}" id="core_js_blog_form" onsubmit="{$sGetJsForm}" enctype="multipart/form-data">
		...
		<div class="table_clear">
			<ul class="table_clear_button">
				...
				<li><input type="submit" name="val[draft_update]" value="{phrase var='blog.update'}" class="button btn-primary" /></li>
				<li><input type="submit" name="val[draft_publish]" value="{phrase var='blog.publish'}" class="button button_off" /></li>
				{else}
				<li><input type="submit" name="val[{if $bIsEdit}update{else}publish{/if}]" value="{if $bIsEdit}{phrase var='blog.update'}{else}{phrase var='blog.publish'}{/if}" class="button btn-primary" /></li>
				{/if}			
