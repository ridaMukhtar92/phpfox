...
<form method="post" action="{url link="user.login"}">
	<div class="table form-group">
		<div class="table_right">
			<input placeholder="{if Phpfox::getParam('user.login_type') == 'user_name'}{phrase var='user.user_name'}{elseif Phpfox::getParam('user.login_type') == 'email'}{phrase var='user.email'}{else}{phrase var='user.login'}{/if}" type="text" name="val[login]" id="js_email" value="" size="30" class="form-control" />
		</div>
	</div>
	...
	<div class="table form-group">
		<div class="table_right">
			<div class="input-group">
				<input placeholder="{phrase var='user.password'}" type="password" name="val[password]" id="js_password" value="" size="30" class="form-control" autocomplete="off" />
