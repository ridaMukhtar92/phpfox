...
{/if}
	...
	<ul id="js_user_browse_advanced_link">
		<li><a href="#" onclick="$('.main_search_browse_button').toggle(); $('#js_user_browse_advanced').toggleClass('active'); return false;" id="user_browse_advanced_link">
                <span class="main_search_browse_button">{phrase var='user.view_advanced_filters'}</span>
                <span class="main_search_browse_button" style="display: none">{phrase var='user.close_advanced_filters'}</span>
            </a></li>
