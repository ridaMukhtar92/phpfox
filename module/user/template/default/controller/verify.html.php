...
{if !isset($sTime)}
	...
	<div>
		<input type="button" value="{phrase var='user.resend_verification_email'}" class="button btn-primary" onclick="$.ajaxCall('user.verifySendEmail', 'iUser={$iVerifyUserId}'); return false;" />
	</div>
{/if}