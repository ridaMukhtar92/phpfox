...
<div class="page_section_menu page_section_menu_header">
	...
	<ul class="nav nav-tabs nav-justified">
		...
		{if count($aGroups)}		
          ...
          <a href="#{$aGroup.group_id}" class="js_custom_change_group" id="group_{$aGroup.group_id}">{phrase var=$aGroup.phrase_var_name}</a>
        </li>
			{/foreach}
		{else}
...
<div class="js_custom_groups js_custom_group_basic">
	...
	<div class="table_clear">
		<input type="submit" value="{phrase var='user.update'}" class="button btn-primary" id="js_custom_submit_button"> <span id="js_custom_update_info"></span>
	</div>
</form>
