...
{/if}
	<div class="user_status_update">
		...
		<div class="p_4" id="js_share_user_status" style="display:none;">
			...
			<div class="t_right">
				<input type="button" value="{phrase var='core.share'}" class="button btn-primary" onclick="$('.user_status_update_ajax').show(); $('#js_share_user_status').hide(); $('#js_global_status_input').ajaxCall('user.updateStatus', 'inline=true');" />
