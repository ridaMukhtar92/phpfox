...
<div class="t_center">
	...
	<div class="p_4 t_right" id="js_share_user_status" style="display:none;">
		<input type="button" value="{phrase var='admincp.save'}" class="button btn-primary" onclick="$('#js_share_user_status').hide(); $('#js_save_note').show(); $('#js_admincp_note').ajaxCall('core.admincp.updateNote'); return false;" />
