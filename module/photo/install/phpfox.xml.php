...
Note: Setting it to "0" (without quotes) is default and users will not have to wait.]]></phrase>
        ...
        <phrase module_id="photo" version_id="4.3.0" var_name="user_setting_maximum_image_width_keeps_in_server" added="1458017923"><![CDATA[Maximum image width keeps in server (in pixel). If image width user upload higher than this value will crop to this value.]]></phrase>
...
- The Pager in the photo section is a bigger button allowing the visitor to simply load more photos.</info>]]></phrase>
		...
		<phrase module_id="photo" version_id="4.2.0" var_name="moderation" added="1451530431"><![CDATA[Moderation]]></phrase>
        <phrase module_id="photo" version_id="4.2.1" var_name="select_photos_s" added="1453708332"><![CDATA[Select photos(s)]]></phrase>
        <phrase module_id="photo" version_id="4.3.0" var_name="maximum_number_of_images_you_can_upload_each_time_is" added="1456215097"><![CDATA[Maximum number of images you can upload each time is:]]></phrase>
        <phrase module_id="photo" version_id="4.4.0" var_name="admin_menu_add_new_category" added="1467773745"><![CDATA[Add new category]]></phrase>
	</phrases>
	<user_group_settings>
