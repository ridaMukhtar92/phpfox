...
<div class="main_break">
	...
	<form method="post" action="{url link='photo.upload.process'}">
		...
		<div class="table_clear">
			<input type="submit" value="{phrase var='photo.save_global_settings'}" class="button btn-primary" name="save_global" />
		</div>	
		...
		<div class="table_clear">
			<input type="submit" value="{phrase var='photo.save'}" class="button btn-primary" name="save" /> {phrase var='photo.and_then'}
		...
		<form method="post" action="{url link='photo.frame'}" id="js_form" enctype="multipart/form-data" target="js_upload_frame" onsubmit="return startProcess(true, true);">
			...
			<div class="table_clear">				
				<div id="js_upload_form_outer">					
					{if isset($sMethod) && $sMethod == 'simple'}
						<input type="submit" value="{phrase var='photo.upload'}" class="button btn-primary" />
					{/if}
	...
	<div id="js_uploaded_images" style="display:none;">
		...
		{/if}
			...
			<div style="padding-top:5px; text-align:right;">
				<input type="submit" value="{phrase var='photo.process_your_photo_s'}" class="button btn-primary" />
			</div>
		</form>	
	</div>		
</div>	
