...
<form method="post" action="{url link='admincp.subscribe.list'}">
	...
	<div class="table_clear">		
		<input type="submit" value="{phrase var='subscribe.update'}" class="button btn-primary" />
		{if $bIsSearching}
		<input type="submit" value="{phrase var='subscribe.reset'}" class="button btn-danger" name="search[reset]" />
		{/if}
	</div>	
</form>
{if count($aPurchases)}
