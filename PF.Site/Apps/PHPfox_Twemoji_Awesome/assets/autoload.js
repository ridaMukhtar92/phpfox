...
$Ready(function() {
	...
	if ($('.global_attachment_list').length) {
		...
		$('.global_attachment_list:not(._twa_built)').each(function() {
			...
			t.append('<li><a href="' + PF.url.make('/emojis') + '" class="emoji-popup no_ajax js_hover_title"><i class="fa fa-smile-o"></i><span class="js_hover_info">Emoji</span></a></li>');
		});
	...
	$('.emoji-popup').unbind().click(function() {
		lastEmojiObject = $(this).parents('form:first').find('textarea:first'), t = $(this);
