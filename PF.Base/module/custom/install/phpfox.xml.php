...
<a href="{link}">{link}</a>]]></phrase>
        <phrase module_id="custom" version_id="4.1.2" var_name="status_id_does_not_exist" added="1450085500"><![CDATA[Status id does not exist]]></phrase>
        <phrase module_id="custom" version_id="4.1.2" var_name="invalid_array" added="1450085693"><![CDATA[Invalid array]]></phrase>
        <phrase module_id="custom" version_id="4.1.2" var_name="user_tagged_you_in_a_comment_in_a_relationship_update" added="1450085852"><![CDATA[{user} tagged you in a comment in a relationship update]]></phrase>
        <phrase module_id="custom" version_id="4.1.2" var_name="relations_are_disabled" added="1450085953"><![CDATA[Relations are disabled]]></phrase>
        <phrase module_id="custom" version_id="4.2.0" var_name="a_relation_does_not_have_relation_data_id_or_with_user_id" added="1450086319"><![CDATA[a relation does not have relation data_id or with user_id]]></phrase>
        <phrase module_id="custom" version_id="4.1.2" var_name="invalid_callback_on_comment_dot" added="1450085998"><![CDATA[Invalid callback on comment.]]></phrase>
        <phrase module_id="custom" version_id="4.1.2" var_name="wrong_type" added="1450086491"><![CDATA[Wrong type]]></phrase>
        <phrase module_id="custom" version_id="4.1.2" var_name="create_a_custom_field" added="1450154283"><![CDATA[Create a Custom Field]]></phrase>
        <phrase module_id="custom" version_id="4.1.2" var_name="custom_relationship_statuses" added="1450168132"><![CDATA[Custom Relationship Statuses]]></phrase>
        <phrase module_id="custom" version_id="4.3.0" var_name="profile_successfully_updated" added="1455504134"><![CDATA[Profile successfully updated!]]></phrase>
	</phrases>
	<user_group_settings>
