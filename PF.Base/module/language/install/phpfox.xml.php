...
Advised size is max 16 pixels (Width & Height).]]></phrase>
		...
		<phrase module_id="language" version_id="4.1.2" var_name="view_less_search_options" added="1449483934">View Less Search Options</phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="filter" added="1449832755">Filter</phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="import" added="1449832886">Import</phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="file" added="1449832934">File</phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="featured_language_packs" added="1449832993">Featured Language Packs</phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="language_package_cannot_be_found_at_dir" added="1450148347"><![CDATA[Language package cannot be found at:  {dir}]]></phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="provide_a_var_name_dot" added="1450148455"><![CDATA[Provide a var name.]]></phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="error_finding_subjects_and_messages" added="1450148503"><![CDATA[Error finding subjects and messages]]></phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="this_shouldnt_happen_dot" added="1450148565"><![CDATA[This shouldnt happen.]]></phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="new_language" added="1450154364"><![CDATA[New Language]]></phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="manual_import" added="1450154547"><![CDATA[Manual Import]]></phrase>
        <phrase module_id="language" version_id="4.1.2" var_name="find_more_language_packs" added="1450154589"><![CDATA[Find More Language Packs]]></phrase>phrases
        <phrase module_id="language" version_id="4.1.2" var_name="languages" added="1450320949"><![CDATA[Languages]]></phrase>
	</phrases>
	<user_group_settings>
