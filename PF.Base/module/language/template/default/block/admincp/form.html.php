    ...
    <div class="table">
        ...
        <div class="table_right">
            <div class="lang_value">
                <textarea class="form-control" cols="50" rows="5" name="val[{$sId}]{if isset($aLanguage.phrase_var_name)}[{$aLanguage.phrase_var_name}]{/if}[{$aLanguage.language_id}]{if isset($sMode)}[{$sMode}]{/if}">{$aLanguage.post_value|htmlspecialchars}</textarea>
            </div>
        </div>
    </div>
{/if}
