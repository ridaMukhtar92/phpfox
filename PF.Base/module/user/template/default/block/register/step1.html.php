...
?>
	<div id="js_register_step1">
		...
		<div class="table form-group">
			<div class="table_right">
				<div class="p_top_8">
					<input class="form-control" type="text" name="val[confirm_email]" id="confirm_email" value="{value type='input' id='confirm_email'}" size="30" onblur="$('#js_form').ajaxCall('user.confirmEmail');" placeholder="{phrase var='user.please_reenter_your_email_again'}"/>
				</div>
		...
		<div class="table form-group">
			<div class="table_right">
				{if isset($bIsPosted)}
				<input class="form-control" placeholder="{phrase var='user.password'}" type="password" name="val[password]" id="password" value="{value type='input' id='password'}" size="30" autocomplete="off" />
				{else}
				<input class="form-control" placeholder="{phrase var='user.password'}" type="password" name="val[password]" id="password" value="" size="30" autocomplete="off" />
				{/if}
			</div>			
		</div>
