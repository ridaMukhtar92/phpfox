...
friend921</info>]]></phrase>
		...
		<phrase module_id="user" version_id="2.0.0beta2" var_name="user_setting_custom_name_field" added="1242643942">Custom full name field. Must be phrase, example: user.full_name</phrase>
...
<b>hide</b> = <i>Hide users age/birthday</i></info>]]></phrase>
		...
		<phrase module_id="user" version_id="3.1.0beta1" var_name="setting_no_show_activity_points" added="1331554285"><![CDATA[<title>Show Activity Points</title><info>Enable this option to show the activity points.</info>]]></phrase>
...
(This setting does not affect the AdminCP)</phrase>
		...
		<phrase module_id="user" version_id="3.5.0" var_name="answers" added="1361782522">Answer(s)</phrase>
		...
		<phrase module_id="user" version_id="4.1.2" var_name="view_less_search_options" added="1449483934">View Less Search Options</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="view_advanced_filters" added="1449817703">View Advanced Filters</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="your_answer" added="1449825911">Your answer...</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="subject" added="1449826123">Subject</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="message" added="1449826179">Message</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="register" added="1449826523">Register</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="invalid_transaction" added="1450150309">Invalid Transaction</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="admin_lacks_permissions" added="1450150401">Admin lacks permissions</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="unable_to_attain_a_password_for_this_account_dot" added="1450150452">Unable to attain a password for this account.</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="passwords_do_not_match" added="1450150493">Passwords do not match</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="not_a_valid_module_dot" added="1450150540">Not a valid module.</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="you_forgot_to_answer_the_captcha_questions" added="1450150588">You forgot to answer the CAPTCHA questions</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="you_have_currently_reached_your_admin_limit_dot_total_admins_out_of_max_admin" added="1450151030"><![CDATA[You have currently reached your Admin limit. ({total_admins} out of {max_admin}')]]></phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="invalid_job_id" added="1450151253">invalid job id</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="no_answers_received" added="1450151294">No answers received</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="could_not_load_file" added="1450151345">Could not load file</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="could_not_upload_files" added="1450151384">Could not upload files</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="invalid_question_id_when_editing_dot" added="1450151807">Invalid question id when editing.</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="create_a_promotion" added="1450155170">Create a Promotion</phrase>
		<phrase module_id="user" version_id="4.1.2" var_name="cancellation_options" added="1450166453">Cancellation Options</phrase>
		<phrase module_id="user" version_id="4.2.0" var_name="setting_require_basic_field" added="1315851732"><![CDATA[<title>Require basic field</title><info>If you select yes, these fields will require when edit profile: country, gender and birthday.</info>]]></phrase>
		<phrase module_id="user" version_id="4.2.0" var_name="sign_in" added="1315851732">Sign in</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="please_reenter_your_email_again" added="1444506853">Please reenter your email again</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="account_verification" added="1455706343">Account Verification</phrase>
		<phrase module_id="user" version_id="4.2.1" var_name="find_friends" added="1454396073">Find Friends</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="your_account_has_been_verified_please_log_in_with_the_information_you_provided_during_sign_up" added="1455792247">Your account has been verified, please log in with the information you provided during sign up.</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="you_still_need_to_verify_your_account" added="1455851994">You still need to verify your account</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="passcode" added="1455865559">Passcode</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="dont_receive_passcode_how_to_get_it" added="1455865785">Have not received passcode yet, How to get it?</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="how_to_get_passcode" added="1455866057">How to get Passcode?</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="google_2step_verify_description" added="1455866341"><![CDATA[<p><b>Google Authenticator</b> generates 2-step verification codes on your phone.</p>
<p>Enable 2-step verification to protect your account from hijacking by adding another layer of security. With 2-step verification signing in will require a code generated by the <b>Google Authenticator</b> app in addition to your account password.
		...
		<phrase module_id="user" version_id="4.3.0" var_name="setting_enable_2step_verification" added="1455867408"><![CDATA[<title>Enable 2-step verification</title><info>Google Authenticator generates 2-step verification codes on your phone.
Enable 2-step verification to protect your account from hijacking by adding another layer of security. With 2-step verification signing in will require a code generated by the Google Authenticator app in addition to your account password.</info>]]></phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="use_google_authencator_app_to_scan_this_qr_code" added="1455867794"><![CDATA[Use <b>Google Authenticator</b> app to scan this QR Code to get passcode]]></phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="enter_your_email" added="1455870543">Enter your email</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="invalid_passcode" added="1455871675">Invalid Passcode</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="get_new_google_authencator_barcode_when_you_change_email" added="1455872440">If you change your email, please scan new Google Authenticator code here</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="account" added="1455619900">Account</phrase>
		<phrase module_id="user" version_id="4.3.0" var_name="from" added="1455769378">From</phrase>
        <phrase module_id="user" version_id="4.4.0" var_name="setting_hide_recommended_user_block" added="1458112834"><![CDATA[Hide block "Users You May Know" in page browse user.]]></phrase>
        <phrase module_id="user" version_id="4.4.0" var_name="users_you_may_know" added="1458267951"><![CDATA[Users You May Know]]></phrase>
		<phrase module_id="user" version_id="4.4.0" var_name="setting_captcha_on_login" added="1458267951"><![CDATA[<title>Captcha on Login</title><info>Enable this option to add a captcha routine to the login process.</info>]]></phrase>
	</phrases>
	<user_group_settings>
	...
	<install><![CDATA[
        ...
        $this->database()->query("CREATE TABLE IF NOT EXISTS `{$sTable}` (`email` varchar(100) NOT NULL DEFAULT '', `token_data` text, PRIMARY KEY (`email`)
) ENGINE=InnoDB;");
	]]></install>
</module>