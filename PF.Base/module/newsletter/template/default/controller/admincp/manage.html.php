			...
			<td class="t_center">
				...
				<div class="link_menu">
					<ul>
						...
						{/if}
						<li><a class="popup" href="{url link='admincp.newsletter.view' id=$aNewsletter.newsletter_id}" title="{phrase var='newsletter.view_newsletter'}">{phrase var='newsletter.view_newsletter'}</a></li>
