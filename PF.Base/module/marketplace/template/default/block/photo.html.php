...
<div class="block">
	...
	<div class="content">
		...
		<div id="js_photo_holder_{$aImage.image_id}" class="row1{if $aForms.image_path == $aImage.image_path} row_focus{/if} js_mp_photo">
			...
			<a href="#" title="{phrase var='marketplace.click_to_set_as_default_image'}" onclick="$('.js_mp_photo').removeClass('row_focus'); $(this).parents('.js_mp_photo:first:not(\'.row_focus\')').addClass('row_focus'); $.ajaxCall('marketplace.setDefault', 'id={$aImage.image_id}'); return false;">
