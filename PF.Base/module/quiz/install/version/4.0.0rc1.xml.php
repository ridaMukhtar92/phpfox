<upgrade>
	<phpfox_update_settings>
		<setting>
			...
			<var_name>quiz_meta_keywords</var_name>
			<phrase_var_name>setting_quiz_meta_keywords</phrase_var_name>
			<ordering>10</ordering>
			<version_id>2.0.0rc1</version_id>
			<value>quiz, test, online, quizzes, tests, free, cool, fun</value>
		</setting>
		<setting>
			<group />
			<module_id>quiz</module_id>
			...
			<version_id>2.0.0rc1</version_id>
			<value><![CDATA[Take Free Fun Quizzes & Tests. Cool Online Fun Quiz & Test. Fun Quizzes and Fun Tests.]]></value>
		</setting>
	</phpfox_update_settings>
	<phpfox_update_menus>
		<menu>
			...
			<disallow_access />
			<module>quiz</module>
			<mobile_icon>puzzle-piece</mobile_icon>
			<value />
		</menu>
	</phpfox_update_menus>
</upgrade>