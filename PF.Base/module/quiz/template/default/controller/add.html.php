...
<form method="post" action="{$sFormAction}" id="js_form" name="js_form" {if $bShowTitle}onsubmit="{$sGetJsForm}"{/if} {if Phpfox::getUserParam('quiz.can_upload_picture')}enctype="multipart/form-data"{/if}>
	...
	{if !$bShowTitle}<div style="display:none;">{/if}
		<div class="table form-group">
			<div class="table_left">
                {required}{phrase var='quiz.title'}:
			</div>
		...
		<div class="table form-group">
			<div class="table_left">
                {required}{phrase var='quiz.description'}:
			</div>
			<div class="table_right">
	...
	{if !$bShowTitle}<div style="display:none;">{/if}
		...
		<div class="table form-group-follow">
			<div class="table_left">
                {if Phpfox::getUserParam('quiz.is_picture_upload_required')}{required}{/if} {phrase var='quiz.banner'}:
			</div>
...
<div class="table_clear">
			<ul class="table_clear_button">
				<li><input type="submit" value="{if isset($aQuiz.quiz_id)}{phrase var='quiz.update'}{else}{phrase var='quiz.submit'}{/if}" class="button btn-primary" /></li>
			</ul>
			<div class="clear"></div>
		</div>
</form>
