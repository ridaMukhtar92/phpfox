		...
		<form method="post" action="{url link='ad.add' id=$aForms.ad_id}">
			...
			<div class="main_break">
				...
				<div class="table_clear">
					<input type="submit" value="{phrase var='ad.submit'}" class="button btn-primary" />
				</div>		
			</div>
		</form>
	{else}
			...
			<form method="post" action="{url link='ad.add'}" id="js_custom_ad_form" enctype="multipart/form-data">
				...
				{if Phpfox::getParam('ad.multi_ad') == true}
					<div id="js_sample_multi_ad_holder">
						<div class="ad_unit_holder_title">{phrase var='ad.sample_ad'}</div>
				...
				<div id="step_1">
					...
					<div class="table_clear" id="js_ad_continue_form_button">
						<input type="button" value="{phrase var='ad.continue'}" class="button btn-primary" id="js_ad_continue_form" />
					</div>	
				</div>
				<div id="js_ad_continue_next_step" style="display:none;">
					...
					<div class="table_clear">
						<input type="submit" value="{phrase var='ad.submit'}" class="button btn-primary" id="js_submit_button" />
					</div>
				</div>
