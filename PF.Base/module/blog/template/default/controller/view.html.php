...
<div class="item_view">
	<div class="item_info">
		<ul>
			<li>{$aItem.time_stamp|convert_time:'blog.blog_time_stamp'}</li>
	...
	<div class="item_bar">
		<div class="item_bar_action_holder">
			{if $aItem.is_approved != 1 && Phpfox::getUserParam('blog.can_approve_blogs')}
				<a href="#" class="item_bar_action approve btn-primary" onclick="$(this).hide(); $('#js_item_bar_approve_image').show(); $.ajaxCall('blog.approve', 'inline=true&amp;id={$aItem.blog_id}'); return false;" title="{phrase var='blog.approve'}"></a>
			{/if}		
