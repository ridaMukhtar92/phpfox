...
<form action="{url link='admincp.egift.categories'}" method="post">
	...
	<div class="table_clear">
		<input type="submit" value="{phrase var='egift.add_category'}" class="button btn-primary">
	</div>
</form>
...
<form action="{url link='admincp.egift.categories'}" method="post">
	...
	<div class="table_clear">
		<span id="edit_button" style="display:none;">
			<input type="submit" value="{phrase var='egift.edit_categories'}" class="button btn-primary">
		</span>
	</div>
</form>
