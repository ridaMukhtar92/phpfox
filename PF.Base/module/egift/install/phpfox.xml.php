<module>
	...
	<phrases>
        ...
        <phrase module_id="egift" version_id="4.1.2" var_name="wrong_format_to_edit_a_phrase_dot" added="1450087041"><![CDATA[Wrong format to edit a phrase.]]></phrase>
        <phrase module_id="egift" version_id="4.1.2" var_name="that_category_doesnt_exist" added="1450087200"><![CDATA[That category doesnt exist]]></phrase>
        <phrase module_id="egift" version_id="4.1.2" var_name="name_must_be_an_array" added="1450087261"><![CDATA[Name must be an array]]></phrase>
        <phrase module_id="egift" version_id="4.1.2" var_name="category_or_phrase_not_found" added="1450087308"><![CDATA[Category or phrase not found]]></phrase>
        <phrase module_id="egift" version_id="4.1.2" var_name="could_not_upload_files" added="1450087353"><![CDATA[Could not upload files]]></phrase>
        <phrase module_id="egift" version_id="4.1.2" var_name="could_not_load_file" added="1450087418"><![CDATA[Could not load file]]></phrase>
        <phrase module_id="egift" version_id="4.1.2" var_name="that_item_does_not_exist_dot" added="1450087454"><![CDATA[That item does not exist.]]></phrase>
	</phrases>
