...
<form method="post" action="{url link='admincp.setting.file'}">
	...
	<div class="table_clear">
		<input type="submit" value="{phrase var='admincp.download'}" class="button btn-primary" />
	</div>
</form>
...
<form method="post" action="{url link='admincp.setting.file'}" enctype="multipart/form-data">
	...
	<div class="table_clear">
		<input type="submit" value="{phrase var='admincp.upload'}" class="button btn-primary" />
	</div>
</form>