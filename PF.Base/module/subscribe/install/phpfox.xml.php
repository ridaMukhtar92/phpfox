...
<a href="{link}">{link}</a>]]></phrase>
        ...
        <phrase module_id="subscribe" version_id="4.1.2" var_name="toggle_comparison_value__yes__no_or_text_field_" added="1449828893">Toggle Comparison Value (Yes, No or Text Field)</phrase>
        <phrase module_id="subscribe" version_id="4.1.2" var_name="toggle_yes_or_no" added="1449829417">Toggle Yes or No</phrase>
        <phrase module_id="subscribe" version_id="4.2.1" var_name="admin_cant_use_this_feature" added="1454041130"><![CDATA[Admin can't use this feature]]></phrase>
        <phrase module_id="subscribe" version_id="4.2.1" var_name="activated_date" added="1454051846"><![CDATA[Activated date]]></phrase>
        <phrase module_id="subscribe" version_id="4.2.1" var_name="type" added="1454052534"><![CDATA[Type]]></phrase>
        <phrase module_id="subscribe" version_id="4.2.1" var_name="other" added="1454053145"><![CDATA[Other]]></phrase>
        <phrase module_id="subscribe" version_id="4.2.1" var_name="one_time" added="1454053177"><![CDATA[One time]]></phrase>
        <phrase module_id="subscribe" version_id="4.2.1" var_name="expiry_date" added="1454053353"><![CDATA[Expiry date]]></phrase>
        <phrase module_id="subscribe" version_id="4.2.1" var_name="no_expiration_date" added="1454054157"><![CDATA[No expiration date]]></phrase>
	</phrases>
