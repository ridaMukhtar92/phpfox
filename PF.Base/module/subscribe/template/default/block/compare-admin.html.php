...
<table id="tbl_compare" cellpadding="0" cellspacing="0">
    ...
    <tr id="tr_features_template" class="tr_feature" style="display:none;">
        ...
        <div>
            <span class="switch_type js_hover_title" onclick="$Core.subscribe.switchType(this);">{img theme='misc/arrow_switch.png'}<span class="js_hover_info">{phrase var='subscribe.toggle_comparison_value__yes__no_or_text_field_'}</span></span>
								<span class="div_text">
								...
								<span class="div_radio js_hover_title" style="display: none;">
									...
									<span class="js_hover_info">{phrase var='subscribe.toggle_yes_or_no'}</span>
								</span>
        </div>
        </td>
        {/foreach}
