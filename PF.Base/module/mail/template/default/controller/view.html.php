...
<div class="item_info">
	...
	<div class="item_bar">
		...
		<div class="item_bar_action_holder">
			<a role="button" data-toggle="dropdown" class="item_bar_action"><span>{phrase var='mail.actions'}</span></a>
	...
	<form method="post" action="{url link='mail.view' id=$aMail.mail_id}" id="js_form_mail" onsubmit="{$sGetJsForm}">
		...
		<div class="table_clear">
			<input type="submit" value="{phrase var='mail.send'}" class="button" id="js_mail_submit btn-primary" />
		</div>
	</form>
	{/if}
	{/if}