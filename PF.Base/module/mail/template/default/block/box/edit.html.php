...
{/foreach}
<div class="p_4">
	<input type="button" value="{phrase var='mail.update'}" class="button btn-primary" id="js_submit_update_folder" /> <input type="button" value="{phrase var='mail.cancel'}" class="button" id="js_cancel_edit_folder" /> <span id="js_process_form_image"></span>
</div>
</form>