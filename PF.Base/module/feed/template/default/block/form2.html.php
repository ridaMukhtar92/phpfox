	...
	<div class="content">
		...
		<div class="feed_form_menu">
			<nav class="nav_header">
				<ul>
					<li><a href="{url link='user.setting'}"><i class="fa fa-cog"></i>{phrase var='feed.account_settings'}</a></li>
					<li><a href="{url link='user.profile'}"><i class="fa fa-edit"></i>{phrase var='feed.edit_profile'}</a></li>
					<li><a href="{url link='friend'}" class="no_ajax"><i class="fa fa-group"></i>{phrase var='feed.manage_friends'}</a></li>
					<li>
