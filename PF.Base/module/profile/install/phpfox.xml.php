...
If this setting is disabled there will be an extra query for each tab in profiles every time site cache is cleared.</info>]]></phrase>
        ...
        <phrase module_id="profile" version_id="4.1.2" var_name="trying_to_load_an_invalid_module_dot" added="1450149732"><![CDATA[Trying to load an invalid module.]]></phrase>
        <phrase module_id="profile" version_id="4.1.2" var_name="unable_to_load_the_section_you_are_looking_for_dot" added="1450149851"><![CDATA[Unable to load the section you are looking for.]]></phrase>
        <phrase module_id="profile" version_id="4.2.0" var_name="upload_photo" added="1450932867"><![CDATA[Upload photo]]></phrase>
	</phrases>
	<user_group_settings>
