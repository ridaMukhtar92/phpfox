	...
	<div class="row1{if $phpfox.iteration.pages == 1} row_first{/if}">
		...
		<div style="margin-left:55px; position:relative;">
			<div style="position:absolute; right:10px; top:8px;">
				<div><input type="button" name="switch" value="{phrase var='pages.switch'}" class="button btn-primary" onclick="$.ajaxCall('pages.processLogin', 'page_id={$aPage.page_id}', 'GET')" /></div>
			</div>
