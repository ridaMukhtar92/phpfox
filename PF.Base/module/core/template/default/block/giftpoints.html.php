	...
	{if $iCurrentAvailable > 1}
		<div class="p_top_8">
			{if $iCurrentAvailable == 1}
				...
				<div class="p_top_8">
					<input type="button" value="{phrase var='core.yes'}" class="button btn-primary" onclick="doGiftPoints();" />
				<div class="p_top_8">
			{else}
				{phrase var='core.how_many_points_do_you_want_to_gift_away'}
				<div class="p_top_8">
					<input type="text" id="txt_amount_points" value="" size="8" /> <input type="button" value="{phrase var='core.gift_points'}" class="button btn-primary" onclick="doGiftPoints();" />
				<div class="p_top_8">
			{/if}
		</div>
	{else}
