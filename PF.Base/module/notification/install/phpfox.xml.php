...
<b>Notice:</b> This setting will only be enabled if the parent setting "<setting>notification.notify_on_new_request</setting>" is enabled.</info>]]></phrase>
		...
		<phrase module_id="notification" version_id="3.3.0beta2" var_name="setting_notification_browse_messages" added="1341248596"><![CDATA[<title>Notification Timestamp</title><info>Timestamp used when a user views all their notifications.</info>]]>
        </phrase>
        <phrase module_id="notification" version_id="4.1.2" var_name="remove_all_notifications" added="1449632614">Remove all notifications</phrase>
	</phrases>
