...
Note: Setting it to "0" (without quotes) is default and users will not have to wait.',
  ...
  'user_setting_maximum_image_width_keeps_in_server' => 'Maximum image width keeps in server (in pixel). If image width user upload higher than this value will crop to this value.',
