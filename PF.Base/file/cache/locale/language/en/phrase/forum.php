...
<a href="{link}">{link}</a>',
  ...
  'setting_total_recent_discussions_display' => '<title>Total Recent Discussions Display</title><info>Define how many discussions should be displayed within the Recent Discussions block.</info>',
  'thanks' => 'Thanks',
  'delete_thanks' => 'Delete thanks',
  'thanks_count' => '{count} thanks',
  'no_one_has_thanked_this_post' => 'No one has thanked this post',
  'setting_enable_thanks_on_posts' => '<title>Enable "Thanks" on posts</title><info>Set to <b>True</b> to enable "Thanks" on posts.
