...
For this to work you need to have entered the Google API Key (<setting>google_api_key</setting></info>) or the IP Info DB Key (<setting>ip_infodb_api_key</setting>)',
  ...
  'show_more' => 'Show More',
  'view_more_plus' => 'More +',
  'setting_allow_choose_sort_on_feeds' => '<title>Allow choose sort type on Main feeds</title><info>Set <b>true</b> to allow users can choose sort type of main feeds in home page.</info>',
);