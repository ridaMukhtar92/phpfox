...
<?php if (Phpfox ::getParam('tag.enable_hashtag_support')): ?>
...
<?php if (count((array)$this->_aVars['aRows'])):  foreach ((array) $this->_aVars['aRows'] as $this->_aVars['aRow']): ?>
				<li>
					<a href="<?php echo $this->_aVars['aRow']['link']; ?>" data-text="<?php echo $this->_aVars['aRow']['key']; ?>" class="site_hash_tag">
<?php if (Phpfox ::getParam('tag.enable_hashtag_support')): ?>#<?php endif;  echo $this->_aVars['aRow']['key']; ?>
					</a>
				</li>
...
<?php echo Phpfox::getPhrase('tag.trending_since_since', array('since' => $this->_aVars['sTrendingSince'])); ?>
	</div>
<?php if (Phpfox ::getParam('tag.enable_hashtag_support')): ?>
		</div>
<?php endif; ?>
<?php else: ?>
	<div class="message">
<?php echo Phpfox::getPhrase('tag.no_tags_have_been_found'); ?>
	</div>
<?php endif; ?>
