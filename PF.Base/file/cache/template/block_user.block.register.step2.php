...
<?php if (Phpfox ::getParam('core.registration_enable_location')): ?>
		<div class="table form-group">
			...
			<div class="table_right">
				<select class="form-control" name="val[country_iso]" id="country_iso">
		<option value=""><?php echo Phpfox::getPhrase('core.select'); ?>:</option>
...
{ 
echo '<script type="text/javascript"> $Behavior.setCountry = function() {$("#js_country_iso_option_' . $this->_aVars['aForms']['country_iso'] . '").prop("selected", true); } </script>';  }
?>
