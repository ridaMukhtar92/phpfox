...
<?php (($sPlugin = Phpfox_Plugin::get('photo.template_block_share_1')) ? eval($sPlugin) : false); ?>
	...
	<div><input type="hidden" name="val[action]" value="upload_photo_via_share" /></div>
		<div id="divFileInput"><input accept="image/*" type="file" name="image[]" id="global_attachment_photo_file_input" value="" onchange="$bButtonSubmitActive = true; $('.activity_feed_form_button .button').removeClass('button_not_active');" /></div>
