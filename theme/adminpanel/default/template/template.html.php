...
<html xmlns="http://www.w3.org/1999/xhtml" dir="{$sLocaleDirection}" lang="{$sLocaleCode}">
	...
	<body>
		...
		<div id="header">
			<a href="#" class="header_logo">{phrase var='admincp.module_admincp'}</a>
		</div>
				...
				<div class="main_menu_holder nano-content">
					...
					<div class="admincp_user">
						...
						<div class="admincp_user_content">
							{$aUserDetails|user}
							<div>
								<a href="{url link=''}">{phrase var='admincp.view_site'}</a>
							</div>
						</div>
					</div>
						...
						<li class="main_menu_link_li"><a class="main_menu_link" href="#">{$sPhrase}</a>
							<div class="main_sub_menu">
								...
								<div class="admincp_search_settings">
									...
									<input type="text" name="setting" placeholder="{phrase var='admincp.search_settings_dot'}" autocomplete="off">
					...
					<div id="main">
						...
						<div class="apps_menu">
							...
							<div class="upgrade_product_holder">
								...
								<a href="{$store.install_url}">Update Now</a>
							</div>
							{/if}
